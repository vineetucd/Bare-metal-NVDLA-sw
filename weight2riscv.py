...
input_file = 'weights_only_plus_100000.dat'  # Input file containing the address and data pairs
output_file = 'wt_only2riscv.s'  # Output file where the RISC-V program will be written
